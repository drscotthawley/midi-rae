...
# %% auto #0
__all__ = ['cjprint', 'rprint', 'set_seed', 'save_checkpoint', 'load_checkpoint']
...
def cjprint(*args, color=None, justify="left", width=None):
    "Prints optionally colored and justified text."
    import shutil
    ...
    if color: text = f"\033[{colors[color]}m{text}\033[0m"
    print(text)
