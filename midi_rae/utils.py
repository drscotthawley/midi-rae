...
# %% auto #0
__all__ = ['to_scalar', 'binarize', 'freemem', 'cjprint', 'rprint', 'cchange', 'crevert', 'set_seed', 'param_count',
           'save_checkpoint', 'load_checkpoint', 'load_optimizer_state_partial', 'EMAModel']
...
def binarize(img, thresh=0.5): 
    """used to turn images on [0.1] into binary floats.
    Leave thresh the same for ALL parts of code, for standardization"""
