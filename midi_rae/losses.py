...
# %% auto #0
__all__ = ['safe_mean', 'SIGReg_nochunk', 'SIGReg', 'attraction_loss', 'LeJEPA', 'calc_mae_loss', 'anchor_loss', 'calc_enc_loss',
...
# %% ../nbs/03_losses.ipynb #7e471aaf-98b1-46d8-b2dd-4781586f5164
def SIGReg_nochunk(x, global_step, num_slices=256, chunk_size=32):
