...
# %% auto #0
__all__ = ['safe_mean', 'SIGReg', 'attraction_loss', 'attraction_loss_new', 'LeJEPA', 'calc_mae_loss', 'anchor_loss',
           'calc_enc_loss', 'calc_enc_loss_multiscale', 'PatchGANDiscriminator']
...
def attraction_loss_new(z1, z2,        # embeddings of two "views" of the same thing (in batches)
                    deltas=None,   # optional/TBD: info on semantic 'distance' between z1 & z2
