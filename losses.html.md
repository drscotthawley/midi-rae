...
def calc_mae_loss(
    recon_patches, img, pos_full, mae_mask, patch_size:int=16, all_patches:bool=False, use_bce:bool=True
):

```

*for now, MSE evaluated at masked patches. TODO: upgrade to some other
loss?*
